...
= Is there a "Pro" version for this theme? =
No, actually there is no "Pro" version, all the features are available for free, however you may still purchase this theme if you want, it can greatly help us with the development.

== Changelog ==

= 1.3.9 =
* Content "Updated on" date included
* Next/Previous Content navigation
* Copyright template file turned into a function
* Continued enhancements for a better preview experience on wp-themes.com (wordpress.org)
* UX improvements
* Bug fixes
* Several improvements

= 1.3.8 =
* Multiple options for the "Continue Reading" buttons
* New social media options
* Updated the Animate.CSS
...
* jQuery Superclick https://github.com/joeldbirch/superfish, (C) Joel Birch, [MIT](https://opensource.org/licenses/MIT)
