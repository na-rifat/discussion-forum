...
;( function( $ ) {
	...
	wp.customize.bind(
		...
		function() {
			...
			$customizer_header.append( '<p><a href="' + pen_customize_js.url_support + '" class="button" target="_blank" style="min-width:100%">' + pen_customize_js.text.support_text + '</a></p>' );

			if ( pen_customize_js.url_rate ) {
				$customizer_header.append( '<p><a href="' + pen_customize_js.url_rate + '" class="button" target="_blank" style="font-weight:bold;min-width:100%">' + pen_customize_js.text.rate + '</a></p>' );
			}

			if ( ! pen_customize_js.plugin_installed ) {
				$customizer_header.append( '<p><a href="' + pen_customize_js.plugin_install_url + '" class="button" target="_blank" style="min-width:100%">' + pen_customize_js.text.install_plugin + '</a></p>' );
			}
