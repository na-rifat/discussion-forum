 ...
 *
 * Customization Export page title.
 *
...
if ( ! function_exists( 'pen_plugin_export_page_title' ) ) {
	/**
	 * Returns a HTML title for the "Customization export" page.
	 *
	 * @since Pen Extra Features 1.0.0
	 * @return void
	 */
	function pen_plugin_export_page_title() {
		$page_title[] = sprintf(
		...
		?>
	<h2 class="pen_plugin_export" id="hp_title">
		<?php
