...
if ( ! function_exists( 'pen_plugin_addons_page_title' ) ) {
	/**
	 * Returns a HTML title for the Addons page.
	 *
	 * @since Pen Extra Features 1.0.0
	 * @return void
	 */
	function pen_plugin_addons_page_title() {
		$page_title[] = sprintf(
		...
		?>
	<h2 class="pen_plugin_addons" id="hp_title">
		<?php
