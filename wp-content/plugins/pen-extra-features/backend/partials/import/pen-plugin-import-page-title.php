 ...
 *
 * Customization Import page title.
 *
...
if ( ! function_exists( 'pen_plugin_import_page_title' ) ) {
	/**
	 * Returns a HTML title for the "Customization import" page.
	 *
	 * @since Pen Extra Features 1.0.0
	 * @return void
	 */
	function pen_plugin_import_page_title() {
		$page_title[] = sprintf(
		...
		if ( filter_input( INPUT_GET, 'hp_back' ) ) {
			$page_title[] = sprintf(
				'<a href="%1$s" class="hp_shortcut_header">%2$s</a>',
		...
		?>
	<h2 class="pen_plugin_import" id="hp_title">
		<?php
